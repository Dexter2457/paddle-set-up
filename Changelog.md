# paddle-set-up
# 4.2.0
Apart from making sure our Mac SDK is ready for the new macOS weâ€™ve also made the following improvements:
- Added allowed_uses and times_used to the license verification response, making it easier to see the userâ€™s remaining activations.
...
- Improved Paddleâ€™s Checkout caching behaviour to prevent future issues with paddle.js updates.

If you donâ€™t have a sandbox account yet, you can create one at https://sandbox-vendors.paddle.com/signup.
